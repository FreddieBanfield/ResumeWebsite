...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="header">
      <div class="heading">
        <h1>About Me</h1>
        <h4>All about Freddie Banfield!</h4>
      </div>
      <div class="top-menu">
        <ul>
          <li><a href="index.php" >Homepage</a></li>
          <li><a href="aboutme.php" class="current_page">About Me</a></li>
      ...
      <div class="body">
        <div class="profile enlarge">
              <img id="main-photo" src="Me.jpg" alt="Picture of Freddie Banfield at the top of a volcano in Maui">
              <h3>Freddie Banfield</h4>
              <p>Hello, my name is Freddie Banfield. I am a 3rd year Okanagan College BCIS student.</p>
        </div>
      </div>
      <footer>
